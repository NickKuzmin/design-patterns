namespace DesignPatterns.Core.AbstractFactory
{
    ...
    class DbClient
    {
        public void Execute()
        {
            ...
            dbLogger.Run(mssqlProviderFactory, "", "SELECT * FROM Users");

            var postgreSqlProviderFactory = new PostgreSqlProviderFactory();
            dbLogger.Run(postgreSqlProviderFactory, "", "SELECT * FROM Users");
        }
    }
}
